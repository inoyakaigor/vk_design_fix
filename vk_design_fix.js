...
.test, .feed_friend_image, a.wk_extpage_owner_thumb, #search_content .three_col_row .img, .fans_fanph_wrap, .fans_idolph_wrap, .friends_bigph_wrap, .wk_likes_likerph_wrap, .wk_pollph_wrap, .wk_poll_usr, .fave_uph_wrap, img.im_user_holder, .im_photo_holder, a.post_image > img,.dialogs_photo > img, .dialogs_photo > a > img, notifier_image, .wide_wall_module a.reply_image, .wide_wall_module img.reply_image, div.feedback_row_photo > a > img.feedback_row_photo, a.reply_form_image, div.pv_thumb > a > img, .ts_contact_photo img, .pad_fr_phwrap, div.im_log_author_chat_thumb, .dialogs_msg_body .dialogs_inline_author, .published_by_photo > img, a.fc_msgs_author, img.fc_contact_photo, a.feedback_group_photo, img.fc_tab_txt_self, .wall_module a.reply_image, #dark_box_ava.pb_ava, .page_list_module .thumb img, .audio_friend_photo, .im_friend img, .pad_fr_common a img, a.ava > img, div.friends_bigph_wrap, .public_contacts_list .image, div.im_chatbox_mem_photo, a.fl_l.pad_nws_photo, .pad_msga_photo, .pad_nwsa_photo, .fw_reply_thumb, a.fl_l.pad_msg_photo, .wk_extpage_friend_subscribed, .like_tt_usr, .poll_tt_usr, .group_row_photo, .gle_thumb, .wddi_thumb, .wdd_img_full, .wl_owner_head_thumb, .fw_post_thumb, .tickets_image, .tu_thumb, .gedit_user_bigph_wrap, a.mention_tt_photo, a.mention_tt_person, .mv_thumb, td.flist_item_img img, .pad_gr_phwrap, .pad_mini_friend , td.notifier_image_wrap > div, #friends .user_block .img, img.feedback_row_photo, .bp_thumb, .ba_thumb, .chat_tab_imgcont > img {\
  border-radius: 0px;\
  border-radius: 50px;\
